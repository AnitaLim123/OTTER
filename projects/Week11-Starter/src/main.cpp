...
int main() {
	...
	// Push another scope so most memory should be freed *before* we exit the app
	{
		...
		float     lightAmbientPowtemp = 0.05f;
		float	  lightSpecularPowtemp = 1.0f;
		...
		shader->SetUniform("u_LightingOff", lightOff);
		shader->SetUniform("u_Ambient", ambientOnly);
		shader->SetUniform("u_Specular", specularOnly);
		shader->SetUniform("u_AmbientAndSpecular", ambSpec);
		shader->SetUniform("u_Custom", custom);
		...
		imGuiCallbacks.push_back([&]() {
			...
			if (ImGui::CollapsingHeader("Toggle Buttons"))
			{
				...
				{
					shader->SetUniform("u_LightingOff", lightOff = 1);
					shader->SetUniform("u_Ambient", ambientOnly = 0);
					shader->SetUniform("u_Specular", specularOnly = 0);
					shader->SetUniform("u_AmbientAndSpecular", ambSpec = 0);
					shader->SetUniform("u_Custom", custom = 0);
				}

				if (ImGui::Button("Ambient Lighting Off"))
				{
					shader->SetUniform("u_LightingOff", lightOff = 0);
				...
				if (ImGui::Button("Specular Lighting Off"))
				{
					shader->SetUniform("u_LightingOff", lightOff = 0);
					shader->SetUniform("u_Ambient", ambientOnly = 0);
				...
				if (ImGui::Button("Ambient & Specular Off"))
				{
					shader->SetUniform("u_LightingOff", lightOff = 0);
					shader->SetUniform("u_Ambient", ambientOnly = 1);
					shader->SetUniform("u_Specular", specularOnly = 1);
				...
				if (ImGui::Button("Toon Shading Off/On"))
				{
					shader->SetUniform("u_LightingOff", lightOff = 0);
					shader->SetUniform("u_Ambient", ambientOnly = 0);
					shader->SetUniform("u_Specular", specularOnly = 0);
					shader->SetUniform("u_AmbientAndSpecular", ambSpec = 0);
					shader->SetUniform("u_Custom", custom = 1);
				}
		...
		Texture2D::sptr duncet = Texture2D::LoadFromFile("images/Duncet.png");
		Texture2D::sptr table = Texture2D::LoadFromFile("images/Table.png");
		Texture2D::sptr treeSmall = Texture2D::LoadFromFile("images/TreeSmall.png");
		Texture2D::sptr balloon = Texture2D::LoadFromFile("images/BalloonLightBlue.png");
		Texture2D::sptr bench = Texture2D::LoadFromFile("images/BenchNew.png");
		Texture2D::sptr ground = Texture2D::LoadFromFile("images/Ground.png");
		Texture2D::sptr cake = Texture2D::LoadFromFile("images/Slice of Cake.png");
		Texture2D::sptr flower = Texture2D::LoadFromFile("images/Flower1.png");
		...
		material2->Set("s_Diffuse", duncet);
		...
		material3->Set("s_Diffuse", balloon);
		...
		material5->Set("s_Diffuse", treeSmall);
		...
		material7->Set("s_Diffuse", ground);
		...
		//the box that everything is on 
		GameObject sceneObj = scene->CreateEntity("Ground"); 
		{
			...
			sceneObj.emplace<RendererComponent>().SetMesh(vao).SetMaterial(material7);
			sceneObj.get<Transform>().SetLocalPosition(0.0f, 0.0f, 0.2f);
			sceneObj.get<Transform>().SetLocalRotation(90.0f, 0.0f, 1.0f);
			sceneObj.get<Transform>().SetLocalScale(0.5f, 0.5f, 0.5f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(sceneObj);
		}

		GameObject obj2 = scene->CreateEntity("Bench");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/Bench.obj");
			obj2.emplace<RendererComponent>().SetMesh(vao).SetMaterial(material4);
			obj2.get<Transform>().SetLocalPosition(0.0f, -2.0f, 0.8f);
			obj2.get<Transform>().SetLocalRotation(90.0f, 0.0f, 1.0f);
			obj2.get<Transform>().SetLocalScale(0.5f, 0.5f, 0.5f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj2); 
		}

		GameObject obj3 = scene->CreateEntity("Duncet");
		{
			...
			obj3.get<Transform>().SetLocalPosition(0.5f, -2.0f, 0.8f);
			obj3.get<Transform>().SetLocalRotation(90.0f, 0.0f, 1.0f);
			obj3.get<Transform>().SetLocalScale(1.0f, 1.0f, 1.0f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj3);
		}

		GameObject obj5 = scene->CreateEntity("TreeSmall");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/TreeSmall.obj");
			obj5.emplace<RendererComponent>().SetMesh(vao).SetMaterial(material5);
			obj5.get<Transform>().SetLocalPosition(3.5f, -2.0f, 2.7f);
			obj5.get<Transform>().SetLocalRotation(90.0f, 0.0f, 1.0f);
			obj5.get<Transform>().SetLocalScale(0.3f, 0.3f, 0.2f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj5);
		}


		GameObject obj7 = scene->CreateEntity("Dunce");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/Dunce.obj");
			obj7.emplace<RendererComponent>().SetMesh(vao).SetMaterial(material6);
			obj7.get<Transform>().SetLocalPosition(-0.5f, -2.0f, 0.8f);
			obj7.get<Transform>().SetLocalRotation(90.0f, 0.0f, 1.0f);
			obj7.get<Transform>().SetLocalScale(1.0f, 1.0f, 1.0f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj7);
		}

		GameObject obj8 = scene->CreateEntity("TreeSmall");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/TreeSmall.obj");
			obj8.emplace<RendererComponent>().SetMesh(vao).SetMaterial(material5);
			obj8.get<Transform>().SetLocalPosition(-3.5f, -2.0f, 2.7f);
			obj8.get<Transform>().SetLocalRotation(90.0f, 0.0f, 1.0f);
			obj8.get<Transform>().SetLocalScale(0.3f, 0.3f, 0.2f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj8);
		}

		GameObject obj9 = scene->CreateEntity("cake");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/SliceofCake.obj");
			obj9.emplace<RendererComponent>().SetMesh(vao).SetMaterial(material9);
			obj9.get<Transform>().SetLocalPosition(-0.25f, 0.75f, 0.5f);
			obj9.get<Transform>().SetLocalRotation(90.0f, 0.0f, 1.0f);
			obj9.get<Transform>().SetLocalScale(0.7f, 0.7f, 0.7f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj9);
		}

		GameObject obj10 = scene->CreateEntity("flower");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/Flower1.obj");
			obj10.emplace<RendererComponent>().SetMesh(vao).SetMaterial(material8);
			obj10.get<Transform>().SetLocalPosition(1.0f, -1.5f, 0.2f);
			obj10.get<Transform>().SetLocalRotation(90.0f, 0.0f, 180.0f);
			obj10.get<Transform>().SetLocalScale(0.3f, 0.3f, 0.2f);
		...
		GameObject obj4 = scene->CreateEntity("moving_box");
		{
				...
				obj4.get<Transform>().SetLocalPosition(0.0f, 0.0f, 4.0f);
				obj4.get<Transform>().SetLocalRotation(90.0f, 0.0f, 1.0f);
