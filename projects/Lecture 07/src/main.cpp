...
// LECTURE 7 
#define STB_IMAGE_IMPLEMENTATION //dont redefine, only done once in the main.cpp
#include <stb_image.h>
...
void loadImage() { //pass the filepath string as an argument
	int channels;
	stbi_set_flip_vertically_on_load(true); //opengl is expecting it in that format
...
bool initGLFW() {
	...
	window = glfwCreateWindow(1000, 800, "LECTURE 07", nullptr, nullptr);
...
int main() {
	...
	//free image space, why leave it in the ram, send to gpu 
