...
int main() {
	...
	// Push another scope so most memory should be freed *before* we exit the app
	{
		...
		Texture2D::sptr chair = Texture2D::LoadFromFile("images/basketball-floor-texture.jpg");
		Texture2D::sptr drawer = Texture2D::LoadFromFile("images/Drawer Texture(Final).png");
		Texture2D::sptr coffee = Texture2D::LoadFromFile("images/coffee cup.jpg");
		Texture2D::sptr folding = Texture2D::LoadFromFile("images/Folding.jpg");
		Texture2D::sptr books = Texture2D::LoadFromFile("images/Books_diffuse_v1.jpg");
		Texture2D::sptr ball = Texture2D::LoadFromFile("images/football_ball_BaseColor.png");
		...
		ShaderMaterial::sptr drawerTex = ShaderMaterial::Create();
		drawerTex->Shader = shader;
		drawerTex->Set("s_Diffuse", drawer);
		drawerTex->Set("s_Specular", noSpec);
		drawerTex->Set("u_Shininess", 8.0f);
		drawerTex->Set("u_TextureMix", 0.0f);

		ShaderMaterial::sptr coffeeTex = ShaderMaterial::Create();
		coffeeTex->Shader = shader;
		coffeeTex->Set("s_Diffuse", coffee);
		coffeeTex->Set("s_Specular", noSpec);
		coffeeTex->Set("u_Shininess", 8.0f);
		coffeeTex->Set("u_TextureMix", 0.0f);

		ShaderMaterial::sptr foldingTex = ShaderMaterial::Create();
		foldingTex->Shader = shader;
		foldingTex->Set("s_Diffuse", folding);
		foldingTex->Set("s_Specular", noSpec);
		foldingTex->Set("u_Shininess", 8.0f);
		foldingTex->Set("u_TextureMix", 0.0f);

		ShaderMaterial::sptr booksTex = ShaderMaterial::Create();
		booksTex->Shader = shader;
		booksTex->Set("s_Diffuse", books);
		booksTex->Set("s_Specular", noSpec);
		booksTex->Set("u_Shininess", 8.0f);
		booksTex->Set("u_TextureMix", 0.0f);

		ShaderMaterial::sptr ballTex = ShaderMaterial::Create();
		ballTex->Shader = shader;
		ballTex->Set("s_Diffuse", ball);
		ballTex->Set("s_Specular", noSpec);
		ballTex->Set("u_Shininess", 8.0f);
		ballTex->Set("u_TextureMix", 0.0f);
		...
		GameObject obj2 = scene->CreateEntity("drawer");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/Drawer.obj");
			obj2.emplace<RendererComponent>().SetMesh(vao).SetMaterial(drawerTex);
			obj2.get<Transform>().SetLocalPosition(0.0f, 0.0f, 0.0f);
			obj2.get<Transform>().SetLocalRotation(90.0f, 0.0f, -180.0f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj2);
		}

		GameObject obj3 = scene->CreateEntity("drawer");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/Drawer.obj");
			obj3.emplace<RendererComponent>().SetMesh(vao).SetMaterial(drawerTex);
			obj3.get<Transform>().SetLocalPosition(2.0f, 0.0f, 0.0f);
			obj3.get<Transform>().SetLocalRotation(90.0f, 0.0f, -180.0f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj3);
		}

		GameObject obj4 = scene->CreateEntity("coffee");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/coffee cup.obj");
			obj4.emplace<RendererComponent>().SetMesh(vao).SetMaterial(coffeeTex);
			obj4.get<Transform>().SetLocalPosition(1.0f, -0.25f, 3.4f);
			obj4.get<Transform>().SetLocalRotation(90.0f, 0.0f, -180.0f);
			obj4.get<Transform>().SetLocalScale(0.1f, 0.1f, 0.1f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj4);
		}

		GameObject obj5 = scene->CreateEntity("designChair1");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/Folding.obj");
			obj5.emplace<RendererComponent>().SetMesh(vao).SetMaterial(foldingTex);
			obj5.get<Transform>().SetLocalPosition(0.9f, 2.0f, 0.0f);
			obj5.get<Transform>().SetLocalRotation(0.0f, 0.0f, 0.0f);
			obj5.get<Transform>().SetLocalScale(0.05f, 0.05f, 0.05f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj5);
		}

		GameObject obj6 = scene->CreateEntity("designChair2");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/Folding.obj");
			obj6.emplace<RendererComponent>().SetMesh(vao).SetMaterial(foldingTex);
			obj6.get<Transform>().SetLocalPosition(0.9f, -5.0f, 0.0f);
			obj6.get<Transform>().SetLocalRotation(0.0f, 0.0f, 180.0f);
			obj6.get<Transform>().SetLocalScale(0.05f, 0.05f, 0.05f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj6);
		}

		GameObject obj7 = scene->CreateEntity("book");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/Books.obj");
			obj7.emplace<RendererComponent>().SetMesh(vao).SetMaterial(booksTex);
			obj7.get<Transform>().SetLocalPosition(2.4f, -1.2f, 3.3f);
			obj7.get<Transform>().SetLocalRotation(0.0f, 0.0f, 180.0f);
			obj7.get<Transform>().SetLocalScale(0.08f, 0.08f, 0.08f);
			BehaviourBinding::BindDisabled<SimpleMoveBehaviour>(obj7);
		}

		GameObject obj8 = scene->CreateEntity("paper_airplane");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/Books.obj");
			obj8.emplace<RendererComponent>().SetMesh(vao).SetMaterial(booksTex);
			obj8.get<Transform>().SetLocalPosition(-2.5f, -10.0f, 3.0f);
			obj8.get<Transform>().SetLocalRotation(90.0f, 0.0f, 0.0f);
			obj8.get<Transform>().SetLocalScale(0.1f, 0.1f, 0.1f);
